...
public interface IDroidSensor
   ...
   *****************************************************/
  public static final int IDROIDSENSOR_UNKNOWN_ID  = -1;
   ...
   * These string constants identify intents generated by sensors, and
   * also extra data fields sent with the intents.
   *************************************************************/
  public static final String SENSOR_INTENT_ACTION   = "com.tumanako.sensors.update";     // Used as the 'Action' for intents from the sensors
  public static final String SENSOR_INTENT_FROMID   = "com.tumanako.sensors.sensorID";   // Name of extra data element used to send the Sensor ID (identified source of a sensor intent)
  public static final String SENSOR_INTENT_DATATYPE = "com.tumanako.sensors.dataType";
  public static final String SENSOR_INTENT_VALUE    = "com.tumanako.sensors.data";
  
  /******** Intent Data Types: *******************
   * When sending data as an extra field in an intent, the sender 
   * includes an extra field with the name SENSOR_INTENT_DATATYPE
   * and one of the following integer values to identify the 
   * type of the data:  
   ***********************************************/
  public static final int SENSOR_UNKNOWN_DATATYPE = -1;
  public static final int SENSOR_FLOAT_DATA = 0;
  public static final int SENSOR_STRING_DATA = 1;
