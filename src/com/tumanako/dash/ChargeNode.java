...
public class ChargeNode implements IDashMessages
  ...
  public static final int CHARGE_NODE_CONNECT      = DashMessages.CHARGE_NODE_ID +  2;      // } Send by the UI: tells us to connect to server. 
  public static final int CHARGE_NODE_CHARGESTART  = DashMessages.CHARGE_NODE_ID +  3;      // }                 tells us to start charging. 
  public static final int CHARGE_NODE_CHARGESTOP   = DashMessages.CHARGE_NODE_ID +  4;      // }                 tells us to stop charging.
  public static final int CHARGE_NODE_HTMLRECEIVED = DashMessages.CHARGE_NODE_ID +  5;      // } Sent by the CommThread class: HTML has arrived from the server. 
  public static final int CHARGE_NODE_XMLRECEIVED  = DashMessages.CHARGE_NODE_ID +  6;      // }                               XML has arrived from the server.
  public static final int CHARGE_NODE_SERVERERROR  = DashMessages.CHARGE_NODE_ID + 99;      // }                               Error connecting to server. 
  /************* Charger Data Tags: **************************************/
  ...
  public void messageReceived(String action, int message, Float floatData, String stringData, Bundle data )
    ...
    switch (message)
      ...
      case CHARGE_NODE_CONNECT:
        ...
        dashMessages.sendData( UIActivity.UI_INTENT_IN, DashMessages.CHARGE_NODE_ID, null,CHARGE_NODE_CONNECT_HTML,getChargeData(STATUS_DISCONNECTED,0f,0f) );
      ...
      case CHARGE_NODE_HTMLRECEIVED:
        ...
        dashMessages.sendData( UIActivity.UI_INTENT_IN, DashMessages.CHARGE_NODE_ID, null, serverPage, getChargeData(STATUS_CONNECTED,0.0f,0.0f) );
        watchdogCounter = 0;
        break;
      ...
      case CHARGE_NODE_XMLRECEIVED:
        ...
        dashMessages.sendData( UIActivity.UI_INTENT_IN, DashMessages.CHARGE_NODE_ID, null, pageHTML, getChargeData(status,chargeCurrent,chargeUnits) );
        watchdogCounter = 0;
        break;
      
      case CHARGE_NODE_SERVERERROR:
        status = STATUS_DISCONNECTED;
        dashMessages.sendData( UIActivity.UI_INTENT_IN, DashMessages.CHARGE_NODE_ID, null, stringData, getChargeData(STATUS_DISCONNECTED,0.0f,0.0f) );      
        break;
