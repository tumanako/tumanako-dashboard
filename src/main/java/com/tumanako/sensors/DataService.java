...
public class DataService extends Service implements IDashMessages
  ...
  private static final int UPDATE_INTERVAL = 1000;    // Carry out update every n mSeconds.
  private static final int WATCHDOG_OVERFLOW = 6;     // Watchdog will cause service to stop if not reset for n x UPDATE_INTERVAL
  ...
  // ---------------DEMO MODE CODE -------------------------------
  public static final String DATA_SERVICE_DEMO      = "DATASERVICE_DEMO";       // An Intent with this Action is generated by the UI to turn demo mode on / off.
  ...
  public DataService()
    {
    super();
    // !!DEBUG!! Log.i(com.tumanako.ui.UIActivity.APP_TAG, " DataService -> Constructor; ");
    }
  ...
  private Runnable updateTimerTask = new Runnable() 
      ...
      public void run()  
        ...
        // Send a "Ping". This will tell us whether any UI activities are still 
        // operating (they should reply with a "Pong"). 
        dashMessages.sendData(UIActivity.UI_PING, null, null, null, null );

        // Update Watchdog counter and check for overflow:
        watchdogCounter++;
        // !!DEBUG!! Log.i(com.tumanako.ui.UIActivity.APP_TAG, " DataService -> Tick. Counter = " + watchdogCounter);        
   ...
   // !!DEBUG!! Log.i(com.tumanako.ui.UIActivity.APP_TAG, " DataService -> onCreate(); ");      
    ...
    public int onStartCommand(Intent intent, int flags, int startId) 
      ...
      // !!DEBUG!! Log.i(com.tumanako.ui.UIActivity.APP_TAG, " DataService -> Received start id " + startId + ": " + intent);
      dashMessages.resume();
      updateStart();
    ...
    public IBinder onBind(Intent intent) 
      {
      // !!DEBUG!! Log.i(com.tumanako.ui.UIActivity.APP_TAG, " DataService -> onBind(); " );
      dashMessages.resume();
    ...
    public boolean onUnbind (Intent intent)
      ...
      // !!DEBUG!! Log.i(com.tumanako.ui.UIActivity.APP_TAG, " DataService -> onUnBind(); " );
      return true;
      }
    ...
    public void onRebind (Intent intent)
      {
      // !!DEBUG!! Log.i(com.tumanako.ui.UIActivity.APP_TAG, " DataService -> onReBind(); " );
    ...
    public void onDestroy() 
      {
      // Service DESTROYED:
      // !!DEBUG!! Log.i(com.tumanako.ui.UIActivity.APP_TAG, " DataService -> onDestroy(); " );
    ...
    public void messageReceived(String action, Integer intData, Float floatData, String stringData, Bundle bundleData)
      {
      if (action.equals(UIActivity.UI_PONG))
        {
        // Pong received from UI (in answer to our ping). Reset the watchdog counter: 
        watchdogCounter = 0;   // Reset the watchdog timer.
        // !!DEBUG!! Log.i(com.tumanako.ui.UIActivity.APP_TAG, " DataService -> Pong. Watchdog reset." );
        }
      
      // ---------------DEMO MODE CODE -------------------------------
      if ( action.equals(DATA_SERVICE_DEMO) && (intData != null) )
        {
        // An intent to turn demo mode on or off.
        if (intData == 0) setDemo(false);
        else              setDemo(true);
        }
      // ---------------DEMO MODE CODE -------------------------------        
      }
